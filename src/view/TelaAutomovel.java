...
public class TelaAutomovel extends javax.swing.JInternalFrame {
    ...
    private void setar_campos(){
        ...
        txtPlaca.setText(tblUser.getModel().getValueAt(setar, 2).toString());
    ...
    private void editar(){
        String sql = "update tb_transporte set nome_transporte =?, placa = ? where id_transporte =?";
        try{
    ...
    private void excluir(){
        String sql = "delete from tb_transporte where id_transporte = ?";
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja remover esse transporte?", "Atenção!", JOptionPane.YES_NO_OPTION);
        if(confirma == JOptionPane.YES_OPTION){
            try{
                ...
                if(excluido > 0){
                    JOptionPane.showMessageDialog(null, "Transporte excluido!");
                    txtNome.setText(null);
                    txtPlaca.setText(null);
    ...
    private void pesquisar(){
        String sql = "select id_transporte as ID, nome_transporte as Transporte, placa as Placa from tb_transporte where nome_transporte like ?";
        try {
            conexao = ModuloConexao.connector();
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtNome.getText() + "%");
    ...
    private void adicionar(){
        String sql = "insert into tb_transporte(nome_transporte,placa) values(?,?)";
        try{
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtNome.getText());
            pst.setString(2, txtPlaca.getText());
            ...
            if(txtNome.getText().isEmpty()){
                JOptionPane.showMessageDialog(null, "O nome do transporte é obrigatório!");
            } else {
                int adicionado = pst.executeUpdate();
                if(adicionado > 0){
                    JOptionPane.showMessageDialog(null, "Transporte cadastrado!");
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, 451, 34));

        txtPlaca.setFont(new java.awt.Font("Monospaced", 0, 18)); // NOI18N
        txtPlaca.setMargin(new java.awt.Insets(2, 8, 2, 2));
        txtPlaca.setPreferredSize(new java.awt.Dimension(300, 22));
        txtPlaca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPlacaActionPerformed(evt);
            }
        });
        getContentPane().add(txtPlaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, 451, 34));

        jLabel11.setText("Campo Obrigatório*");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 90, 120, -1));
        ...
        jLabel3.setText("Novo Transporte");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 243, 770, 220));

        txtId.setEditable(false);
        getContentPane().add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 50, 34));
